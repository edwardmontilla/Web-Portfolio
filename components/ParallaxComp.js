...
{/* Welcome text */}
            <ParallaxLayer offset={0.2} speed={0.32}>
                <div className="absolute left-0 top-0 transform -translate-y-1/2 ml-40 sm:ml-20 md:ml-40">
                    <p className="text-6xl font-bold text-text animate-slideFadeRight sm:text-xl md:text-xl">Welcome!</p>
                </div>
            </ParallaxLayer>
