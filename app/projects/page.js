...
const Projects = () => {
    return (
        <>
        <div id="proj" className="p-4 m-4 transition ease-in-out bg-white border rounded-lg shadow-md border-primary shadow-secondary hover:translate-y-[-2px]">  {/* this is the container for the projects */}
