...
const Projects = () => {
    return (
        <>
        <div id="proj" className="p-4 m-4 bg-white border rounded-lg shadow-md border-primary shadow-secondary">  {/* this is the container for the projects */}
            <div id="proj-img" className="">
                ...
                <div>
                    <a href="https://www.google.com" className="relative mt-24 m-8font-semibold metropolisR gitlink hover:underline" target="_blank" rel="noopener noreferrer">see more &#10140;</a> {/* this is the link to the project's GitHub repository */}
                </div>
            </div>
        </div>
        <div id="proj" className="p-4 m-4 bg-white border rounded-lg shadow-md border-primary shadow-secondary">  {/* this is the container for the projects */}
